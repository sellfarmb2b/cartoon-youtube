    ...
    for idx, scene in enumerate(scene_data_with_timestamps, 1):
        ...
        try:
            ...
            if include_subtitles:
                ...
                subtitle_kwargs["force_style"] = f"OutlineColour=&HFF000000,BackColour=&H00000000,BorderStyle=3,Outline=20"
            ...
            try:
                ...
                try:
                    ...
                    if include_subtitles and os.path.exists(scene_subtitle_ass) and os.path.getsize(scene_subtitle_ass) > 0:
                        ...
                        # force_style 활성화 - FFmpeg 필터에서도 스타일 강제 적용
                        fallback_subtitle_kwargs["force_style"] = f"OutlineColour=&HFF000000,BackColour=&H00000000,BorderStyle=3,Outline=20"
