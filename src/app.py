...
def srt_to_ass(srt_file: str, ass_file: str):
    ...
    try:
        ...
        ass_content = [
            ...
            # BackColour=&H60000000: 반투명 검정 배경 (Alpha 96)
            f"Style: Default,{SUBTITLE_FONT_NAME},85,&H00FFFFFF,&H000000FF,&HFF000000,&H60000000,0,0,0,0,100,100,0,0,3,20,0,2,10,10,50,1\n",
            "\n",
            "[Events]\n",
    ...
    for idx, scene in enumerate(scene_data_with_timestamps, 1):
        ...
        try:
            ...
            if include_subtitles:
                ...
                subtitle_kwargs["force_style"] = f"OutlineColour=&HFF000000,BackColour=&H60000000,BorderStyle=3,Outline=20"
            ...
            try:
                ...
                try:
                    ...
                    if include_subtitles and os.path.exists(scene_subtitle_ass) and os.path.getsize(scene_subtitle_ass) > 0:
                        ...
                        # force_style 활성화 - FFmpeg 필터에서도 스타일 강제 적용
                        fallback_subtitle_kwargs["force_style"] = f"OutlineColour=&HFF000000,BackColour=&H60000000,BorderStyle=3,Outline=20"
